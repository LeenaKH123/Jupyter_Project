...
# added by lina for pygmentize
# export PATH="${HOME}/home/linux_user_lilo/.local/bin/pygmentize:${PATH}
...
export PATH="${HOME}/.pyenv/bin:${HOME}/.local/bin:${PATH}" # Needed for Linux/WSL
